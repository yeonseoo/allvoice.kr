...
// echo "<script>alert('{$member['mb_id']}');</script>";
...
/*
echo "<script>alert('{$CST_PLATFORM}');</script>";
echo "<script>alert('{$CST_MID}');</script>";
echo "<script>alert('{$LGD_MID}');</script>";
echo "<script>alert('{$LGD_HASHDATA}');</script>";
echo "<script>alert('{$LGD_BUYER}');</script>";
echo "<script>alert('{$LGD_BUYERSSN}');</script>";
echo "<script>alert('{$LGD_NAMECHECKYN}');</script>";
echo "<script>alert('{$LGD_HOLDCHECKYN}');</script>";
echo "<script>alert('{$LGD_MOBILE_SUBAUTH_SITECD}');</script>";
echo "<script>alert('{$LGD_CUSTOM_SKIN}');</script>";
echo "<script>alert('{$LGD_TIMESTAMP}');</script>";
echo "<script>alert('{$LGD_CUSTOM_USABLEPAY}');</script>";
echo "<script>alert('{$LGD_WINDOW_TYPE}');</script>";
echo "<script>alert('{$LGD_RETURNURL}');</script>";
*/
