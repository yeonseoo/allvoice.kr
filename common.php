...
$gender_arr = Array('m'=>'남성','f'=>'여성');
$age_arr = Array('1'=>'유아','2'=>'아동','3'=>'청소년','4'=>'젊은성인','5'=>'중년','6'=>'노년');
$style_arr = Array('1'=>'밝은','2'=>'귀여운','3'=>'섹시한','4'=>'순수한','5'=>'재미있는','6'=>'따뜻한','7'=>'차분한','8'=>'힘있는','9'=>'권위있는','10'=>'시크한','11'=>'사악한');
$tone_arr = Array('1'=>'저음','2'=>'중음','3'=>'고음');
$language_arr = Array('1'=>'표준어','2'=>'전라도','3'=>'경상도','4'=>'강원도','5'=>'충청도','6'=>'그외','7'=>'영어','8'=>'중국어','9'=>'일어','10'=>'기타 외국어');
$script_arr = Array('1'=>'12pt 기준 A4한장','2'=>'12pt 기준 A4두장','3'=>'12pt 기준 A4세장이상');

$gender_select .= "<option value=\"m\">남성</option>\n<option value=\"f\">여성</option>\n";
$age_select .= "<option value=\"1\">유아</option>\n<option value=\"2\">아동</option>\n<option value=\"3\">청소년</option>\n<option value=\"4\">젊은성인</option>\n<option value=\"5\">중년</option>\n<option value=\"6\">노년</option>\n";
$style_select .= "<option value=\"1\">밝은</option>\n<option value=\"2\">귀여운</option>\n<option value=\"3\">섹시한</option>\n<option value=\"4\">순수한</option>\n<option value=\"5\">재미있는</option>\n<option value=\"6\">따뜻한</option>\n<option value=\"7\">차분한</option>\n<option value=\"8\">힘있는</option>\n<option value=\"9\">권위있는</option>\n<option value=\"10\">시크한</option>\n<option value=\"11\">사악한</option>\n";
$tone_select .= "<option value=\"1\">저음</option>\n<option value=\"2\">중음</option>\n<option value=\"3\">고음</option>\n";
$language_select .= "<option value=\"1\">표준어</option>\n<option value=\"2\">전라도</option>\n<option value=\"3\">경상도</option>\n<option value=\"4\">강원도</option>\n<option value=\"5\">충청도</option>\n<option value=\"6\">그외</option>\n<option value=\"7\">영어</option>\n<option value=\"8\">중국어</option>\n<option value=\"9\">일어</option>\n<option value=\"10\">기타 외국어</option>\n";

if ( $_SERVER['HTTP_X_REQUESTED_WITH'] == "com.allvoice.mobileapp" ) {
    $_set_device = true;
}
else {
    $_set_device = false;
