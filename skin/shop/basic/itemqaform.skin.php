...
<div id="sit_qa_write" class="new_win">
	...
	<input type="hidden" name="iq_secret" id="iq_secret" value="0">
	...
	<input type="hidden" name="iq_hp" id="iq_hp" value="<?php echo get_text($qa['iq_hp']); ?>" class="frm_input full_input" size="20" placeholder="휴대폰">
        ...
        <ul>
            ...
            <li>
                <div class="form_left">
                    ...
                    <input type="hidden" name="iq_email" id="iq_email" value="<?php echo get_text($qa['iq_email']); ?>" class="frm_input full_input" size="30" placeholder="이메일"><br>
                    <span class="frm_info">이메일을 입력하시면 답변 등록 시 답변이 이메일로 전송됩니다.</span>
                </div>
                <div class="form_right">
                    <label for="iq_hp" class="sound_only">휴대폰</label>
                    <input type="hidden" name="iq_hp" id="iq_hp" value="<?php echo get_text($qa['iq_hp']); ?>" class="frm_input full_input" size="20" placeholder="휴대폰"><br>
