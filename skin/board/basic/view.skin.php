...
<article id="bo_v" style="width:<?php echo $width; ?>;background-color:#fff;">
    <header>
        <h2 id="bo_v_title">
    ...
    <section id="bo_v_info">
        ...
        <strong class="if_date" style="font-style:normal;"><span class="sound_only">작성일</span> <?php echo date("y-m-d", strtotime($view['wr_datetime'])) ?></strong>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
           <li><a href="<?php echo $list_href ?>" class="btn_b02 btn" style="background-color:#999 !important;">목록</a></li>
            <?php if ($reply_href) { ?><li><a href="<?php echo $reply_href ?>" class="btn_b02 btn">답변</a></li><?php } ?>
