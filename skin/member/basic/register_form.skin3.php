	...
	<div class="voiceDetailInfo">
         ...
         <div id="register_form"  class="form_01">
         	...
         	<table class="joinForm">
         		...
         		<tbody>
         			<tr>
             			<th>유형</th>
             			<td>
             				<input type="radio" id="typeA" />
             				<label for="typeA">개인</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             				<input type="radio" id="typeB" />
             				<label for="typeB">기업</label>
             			</td>
         			</tr>
         			<tr>
             			<th>아이디</th>
             			<td>
             				<input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" <?php echo $required ?> <?php echo $readonly ?> class="frm_input full_input <?php echo $required ?> <?php echo $readonly ?>" minlength="3" maxlength="20" placeholder="영문자, 숫자, _ 만 입력 가능. 최소 3자이상 입력하세요.">
             				<!-- 
         			...
         			<tr>
             			<th>생년월일</th>
             			<td><input type="date" class="frm_input full_input <?php echo $required ?> <?php echo $readonly ?>"></td>
         			</tr>
         			<tr>
             			<th>연락처</th>
             			<td><input type="text" class="frm_input full_input <?php echo $required ?> <?php echo $readonly ?>" placeholder="000-0000-0000"></td>
         			</tr>
         			<tr>
             			<th>이메일</th>
         			...
         			<tr>
             			<th>주소</th>
             			<td><input type="text" class="frm_input full_input <?php echo $required ?> <?php echo $readonly ?>"></td>
         			</tr>
         			<tr>
             			<th>은행명</th>
             			<td><input type="text" class="frm_input full_input <?php echo $required ?> <?php echo $readonly ?>"></td>
            ...
            <div id="joinAgree">
            	...
            	<p>
            		귀하가 수신에 대한 동의를 철회할 때까지, 회사는 귀하에게 회사의 아티스트, 제품 및 서비스의 홍보, 제품 등의 판매 권유, 이벤트 알림 등 마케팅 및 영리 목적의 전자우편/문자메세지를 전송하기 위해, 귀하의 동의를 받아 수집한 개인정보를 이용할 수 있습니다. 귀하는 이에 동의하지 않으실 수 있으며, 이 경우에도 웹사이트 회원가입은 가능하나, 전자우편/문자메세지를 통해 회사가 제공하는 아티스트 관련 정보나 안내, 알림 등을 받으실 수 없음을 알려 드립니다 
            	</p>
            	<div>
