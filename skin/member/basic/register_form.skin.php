    ...
    <div id="register_form" class="form_01">
        ...
        <table class="joinForm">
            ...
            <tr>
                <th>유형</th>
                <td>
                    <input type="radio" id="mb_gubun1" name="mb_gubun" value="1" <?php echo $member['mb_gubun'] == "1" || $member['mb_gubun'] == "" ? "checked" : "" ?> />
                    <label for="mb_gubun1">개인</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" id="mb_gubun2" name="mb_gubun" value="2" <?php echo $member['mb_gubun'] == "2" ? "checked" : "" ?> />
                    <label for="mb_gubun2">기업</label>
                </td>
            </tr>
            <tr>
                <th>아이디</th>
                <td>
                    <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" <?php echo $required ?> <?php echo $readonly ?> class="frm_input full_input <?php echo $required ?> <?php echo $readonly ?>" minlength="3" maxlength="20"
                           placeholder="영문자, 숫자만 입력 가능. 최소 3자이상 입력하세요.">
                    <!--
            ...
            <tr>
                ...
                <td>
                    <?php if ($config['cf_use_hp'] || $config['cf_cert_hp']) { ?>
                        ...
                        <input type="text" name="mb_hp" value="<?php echo get_text($member['mb_hp']) ?>" id="reg_mb_hp" <?php echo ($config['cf_req_hp']) ? "required" : ""; ?> class="frm_input right_input half_input <?php echo ($config['cf_req_hp']) ? "required" : ""; ?>" maxlength="20"
                               placeholder="휴대폰번호">
            ...
            <tr id="company1" <?php echo $member['mb_gubun'] == "2" ? "" : "style='display:none'" ?>>
                <th>업체명</th>
                <td><input type="text" name="mb_4" value="<?php echo isset($member['mb_4']) ? $member['mb_4'] : ''; ?>" id="reg_mb_4" <?php echo $member['mb_gubun'] == "2" ? "required" : "" ?> class="frm_input full_input" size="70" maxlength="100"></td>
            </tr>
            <tr id="company2" <?php echo $member['mb_gubun'] == "2" ? "" : "style='display:none'" ?>>
                <th>사업자등록번호</th>
                <td><input type="text" name="mb_5" value="<?php echo isset($member['mb_5']) ? $member['mb_5'] : ''; ?>" id="reg_mb_5" <?php echo $member['mb_gubun'] == "2" ? "required" : "" ?> class="frm_input full_input" size="70" maxlength="100"></td>
            </tr>
            <tr id="company3" <?php echo $member['mb_gubun'] == "2" ? "" : "style='display:none'" ?>>
                <th>업태</th>
                <td><input type="text" name="mb_6" value="<?php echo isset($member['mb_6']) ? $member['mb_6'] : ''; ?>" id="reg_mb_6" <?php echo $member['mb_gubun'] == "2" ? "required" : "" ?> class="frm_input full_input" size="70" maxlength="100"></td>
            </tr>
            <tr id="company4" <?php echo $member['mb_gubun'] == "2" ? "" : "style='display:none'" ?>>
                <th>종목</th>
                <td><input type="text" name="mb_7" value="<?php echo isset($member['mb_7']) ? $member['mb_7'] : ''; ?>" id="reg_mb_7" <?php echo $member['mb_gubun'] == "2" ? "required" : "" ?> class="frm_input full_input" size="70" maxlength="100"></td>
            </tr>
            </tbody>
        </table>
             ...
             -->
                ...
                <?php if ($config['cf_use_homepage']) { ?>
                    <li>
                        ...
                        <input type="text" name="mb_homepage" value="<?php echo get_text($member['mb_homepage']) ?>" id="reg_mb_homepage" <?php echo $config['cf_req_homepage'] ? "required" : ""; ?> class="frm_input full_input <?php echo $config['cf_req_homepage'] ? "required" : ""; ?>" size="70"
                ...
                <!-- <?php if ($config['cf_use_hp'] || $config['cf_cert_hp']) { ?>
                <th><label for="reg_mb_hp" class="sound_only">휴대폰번호<?php if ($config['cf_req_hp']) { ?><strong>필수</strong><?php } ?></label></th>
                <td>
...
<script>
    $(function () {
        $("#mb_gubun1, #mb_gubun2").click(function () {
            if ($("#mb_gubun1").is(":checked") == true) {
                $("#company1, #company2, #company3, #company4").css("display", "none");
            } else {
                $("#company1, #company2, #company3, #company4").css("display", "");
            }
        });
