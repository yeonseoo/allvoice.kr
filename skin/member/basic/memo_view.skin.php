...
<div id="memo_view" class="new_win">
    ...
    <div class="new_win_con">
        ...
        <div class="win_btn">
            <?php if($prev_link) {  ?>
            <a href="<?php echo $prev_link ?>" class="btn btn_b02" style="margin-left:5px;">이전쪽지</a>
            <?php }  ?>
            <?php if($next_link) {  ?>
            <a href="<?php echo $next_link ?>" class="btn btn_b02" style="margin-left:5px;">다음쪽지</a>
            <?php }  ?>
            &nbsp;
            <a href="<?php echo $list_link ?>" class="btn btn_b02" style="margin-left:5px;"> 목록</a>
