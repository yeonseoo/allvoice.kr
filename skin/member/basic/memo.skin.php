...
<div id="memo_list" class="new_win">
    <h1 id="win_title"><img src="../theme/basic/img/btn_pPost.png" style="vertical-align:middle;display:inline-block;margin-top:-3px;" /> 내 메시지함</h1>
    <div class="new_win_con">
        <ul class="win_ul">
            <li class="<?php if ($kind == 'recv') {  ?>selected<?php }  ?>"><a href="./memo.php?kind=recv">받은메시지</a></li>
            <li class="<?php if ($kind == 'send') {  ?>selected<?php }  ?>"><a href="./memo.php?kind=send">보낸메시지</a></li>
            <li><a href="./memo_form.php">메시지쓰기</a></li>
        </ul>
        <div class="win_total">
            <span>
