...
#ttrxHeader{display:none !important;}
</style>
...
<div id="memo_write" class="new_win">
    ...
    <div class="new_win_con">
        <ul class="win_ul">
            <li><a href="./memo.php?kind=recv">받은메시지</a></li>
            <li><a href="./memo.php?kind=send">보낸메시지</a></li>
            <li class="selected"><a href="./memo_form.php">메시지쓰기</a></li>
        </ul>
