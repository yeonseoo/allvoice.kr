...
<li><a href="#anc_sodr_tax">세금계산서정보 확인</a></li>
        ...
        <form name="frmorderform" method="post" action="./orderformcartupdate.php" onsubmit="return form_submit(this);">
            ...
            <div class="btn_list02 btn_list">
                <p>
                    ...
                    <input type="submit" name="ct_status" value="진행중" onclick="document.pressed=this.value" class="btn_02 color_01">
                    <input type="submit" name="ct_status" value="작업진행중" onclick="document.pressed=this.value" class="btn_02 color_02">
                    <input type="submit" name="ct_status" value="의뢰완료" onclick="document.pressed=this.value" class="btn_02 color_03">
                    <input type="submit" name="ct_status" value="거래합의중" onclick="document.pressed=this.value" class="btn_02 color_04">
                    <input type="submit" name="ct_status" value="작업완료" onclick="document.pressed=this.value" class="btn_02 color_05">
                    <input type="submit" name="ct_status" value="취소" onclick="document.pressed=this.value" class="btn_02 color_06">
                    <input type="submit" name="ct_status" value="의뢰취소" onclick="document.pressed=this.value" class="btn_02 color_06">
...
?>
    ...
    <section id="anc_sodr_tax">
        <form name="frmorderreceiptform2" action="./orderformreceiptupdate2.php" method="post" autocomplete="off">
            <h2 class="h2_frm">결제수단</h2>
            <input type="hidden" name="od_id" value="<?php echo $od_id; ?>">
            <div class="tbl_frm01">
                <input type="radio" name="od_status2" value="" id="od_status_all2" <?php echo get_checked($od['od_settle_case'], ''); ?>>
                <label for="od_status_all2">결제수단없음</label>
                <input type="radio" name="od_status2" value="무통장" id="od_status_income2" <?php echo get_checked($od['od_settle_case'], '무통장'); ?>>
                <label for="od_status_income2">무통장</label>
                <input type="radio" name="od_status2" value="가상계좌" id="od_status_income2" <?php echo get_checked($od['od_settle_case'], '가상계좌'); ?>>
                <label for="od_status_income2">가상계좌</label>
                <input type="radio" name="od_status2" value="계좌이체" id="od_status_income2" <?php echo get_checked($od['od_settle_case'], '계좌이체'); ?>>
                <label for="od_status_income2">계좌이체</label>
                <input type="radio" name="od_status2" value="신용카드" id="od_status_income2" <?php echo get_checked($od['od_settle_case'], '신용카드'); ?>>
                <label for="od_status_income2">신용카드</label>
            </div>
            <input type="submit" value="결제수단 변경" class="btn_submit btn">
        </form>
    </section>
                    ...
                    <td>
                        ...
                        <input type="text" name="od_deposit_name" value="<?php echo get_text($od['od_deposit_name']); ?>" id="od_deposit_name" class="frm_input">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="od_bank_chk" id="od_bank_chk" value="<?php echo date("Y-m-d H:i:s", G5_SERVER_TIME); ?>"
                            ...
                            <?php if ($od['od_settle_case'] == '휴대폰') { ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="od_hp_chk" id="od_hp_chk" value="<?php echo date("Y-m-d H:i:s", G5_SERVER_TIME); ?>"
                            ...
                            <?php if ($od['od_settle_case'] == '신용카드') { ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="od_card_chk" id="od_card_chk" value="<?php echo date("Y-m-d H:i:s", G5_SERVER_TIME); ?>"
    ...
    <section id="anc_sodr_tax">
        <h2 class="h2_frm">세금계산서정보 확인</h2>
        <div class="tbl_frm01">
            <table>
                <caption>결제상세정보 수정</caption>
                <tbody>
                <?php
                $q = "select * from g5_order_tax where od_id='" . $_REQUEST["od_id"] . "' ";
                $tax_arr = sql_fetch($q);
                if ($tax_arr['tax_cash_select'] == '세금계산서') {
                    ?>
                    <tr>
                        <th scope="row" colspan=1><label for="od_bank_account">영수증 종류</label></th>
                        <td colspan=3><?php echo $tax_arr['tax_cash_select']; ?></td>
                    </tr>
                    <tr>
                        <th><label for="od_receipt_price"> 상호명</label></th>
                        <td>
                            <?php echo $tax_arr['coNm']; ?>
                        </td>
                        <th><label for="od_receipt_price"> 대표자명</label></th>
                        <td>
                            <?php echo $tax_arr['coBossName']; ?>
                        </td>
                    </tr>
                    <tr>
                        <th><label for="od_receipt_price"> 사업자등록번호</label></th>
                        <td>
                            <?php echo $tax_arr['coNo']; ?>
                        </td>
                        <th><label for="od_receipt_price"> 사업장 소재지</label></th>
                        <td>
                            <?php echo "(" . $tax_arr['delivery_return_zip'] . ") " . $tax_arr['delivery_return_addr1'] . " " . $tax_arr['delivery_return_addr2'] . " " . $tax_arr['delivery_return_addr3']; ?>
                        </td>
                    </tr>
                    <tr>
                        <th><label for="od_receipt_price"> 업태</label></th>
                        <td>
                            <?php echo $tax_arr['coBusiness']; ?>
                        </td>
                        <th><label for="od_receipt_price"> 업종 소재지</label></th>
                        <td>
                            <?php echo $tax_arr['coType']; ?>
                        </td>
                    </tr>
                    <tr>
                        <th><label for="od_receipt_price"> 당담자명</label></th>
                        <td>
                            <?php echo $tax_arr['coName']; ?>
                        </td>
                        <th><label for="od_receipt_price"> 받는분 이메일</label></th>
                        <td>
                            <?php echo $tax_arr['coEmail']; ?>
                        </td>
                    </tr>
                <?php } else if ($tax_arr['tax_cash_select'] == '현금영수증') { ?>
                    <tr>
                        <th scope="row"><label for="od_bank_account">영수증 종류</label></th>
                        <td><?php echo $tax_arr['tax_cash_select']; ?></td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="od_receipt_price">신청방법</label></th>
                        <td>
                            <?php echo $tax_arr['method']; ?>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="od_receipt_time">정보</label></th>
                        <td>
                            <?php
                            #print_r($tax_arr);
                            if ($tax_arr['method'] == "휴대폰번호") {
                                echo $tax_arr['ph1'] . "-" . $tax_arr['ph2'] . "-" . $tax_arr['ph3'];
                            } else if ($tax_arr['method'] == "사업자등록번호") {
                                echo $tax_arr['coNumber1'] . "-" . $tax_arr['coNumber2'] . "-" . $tax_arr['coNumber3'];
                            } else if ($tax_arr['method'] == "현금영수증 카드번호") {
                                echo $tax_arr['ca1'] . "-" . $tax_arr['ca2'] . "-" . $tax_arr['ca3'] . "-" . $tax_arr['ca4'];
                            }
                            ?>
                        </td>
                    </tr>
    ...
    <section id="anc_sodr_memo">
        <h2 class="h2_frm">작업완료파일</h2>
        <div class="local_desc02 local_desc">
            <?php
            if ($od['od_status'] == "작업진행중" || $od['od_status'] == "작업완료") {
                $sql = "SELECT * FROM " . $g5['g5_shop_order_voice_table'] . " WHERE od_id='" . $od['od_id'] . "' ORDER BY ov_id";
                $res11 = sql_query($sql);
                $row_cnt11 = sql_num_rows($res11);
                if ($row_cnt11 > 0) {
                    ?>
                    <ul class="orderDetailViewCont">
                        ...
                        for ($i = 0; $row = sql_fetch_array($res11); $i++) {
                            ...
                            <li>
                                ...
                                <div>
                                    <?php echo $row['ov_voice_name']; ?>&nbsp;&nbsp;&nbsp;<a href="../../shop/download2.php?ov_id=<?php echo $row['ov_id']; ?>" class="downloadBtn">Download</a>
                                </div>
                            </li>
                            <?php
                        }
