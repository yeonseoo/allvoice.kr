...
$where = " where it_gubun IN ('1','2') AND it_use='1' ";
$sql_search = $where;
if ($stx != "") {
    if ($sfl != "") {
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col"><?php echo subject_sort_link("it_type1", $qstr, 1); ?>메인<br>노출</a></th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_chk2">
            <label for="type1_<?php echo $i; ?>" class="sound_only">메인노출</label>
