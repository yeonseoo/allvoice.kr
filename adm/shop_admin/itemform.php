...
else if ($w == "u")
{
    ...
    $sql = "select * from g5_shop_item as a
            left join (select mb_id, mb_name as maker_name, mb_hp as maker_hp from g5_member) as b On a.it_maker = b.mb_id
            left join (select mb_id, mb_name as origin_name, mb_hp as origin_hp from g5_member) as c On a.it_origin = c.mb_id
            where a.it_id = '$it_id'";
...
<section id="anc_sitfrm_ini">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="it_maker">의뢰회원</label></th>
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
                <input type="text" name="it_maker" value="<?php echo get_text($it['it_maker']); ?>" id="it_maker" class="frm_input" size="30">
                <input type="text" name="it_maker_name" value="<?php echo get_text($it['maker_name']); ?>" id="it_maker_name" class="frm_input" size="40">
                <input type="text" name="it_maker_hp" value="<?php echo get_text($it['maker_hp']); ?>" id="it_maker_hp" class="frm_input" size="20">
            </td>
            <td class="td_grpset">
        ...
        <tr>
            <th scope="row"><label for="it_origin">성우회원</label></th>
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
                <input type="text" name="it_origin" value="<?php echo get_text($it['it_origin']); ?>" id="it_origin" class="frm_input" size="30">
                <input type="text" name="it_origin_name" value="<?php echo get_text($it['origin_name']); ?>" id="it_origin_name" class="frm_input" size="40">
                <input type="text" name="it_origin_hp" value="<?php echo get_text($it['origin_hp']); ?>" id="it_origin_hp" class="frm_input" size="20">
            </td>
            <td class="td_grpset">
		...
		<tr>
            <th scope="row"><label for="it_explan2">샘플 문장</label></th>
            <td><textarea name="it_explan2" id="it_explan2"><?php echo $it['it_explan2']; ?></textarea></td>
            <!--td class="td_grpset">
                <input type="checkbox" name="chk_ca_it_shop_memo" value="1" id="chk_ca_it_shop_memo">
                <label for="chk_ca_it_shop_memo">분류적용</label>
                <input type="checkbox" name="chk_all_it_shop_memo" value="1" id="chk_all_it_shop_memo">
...
<section id="anc_sitfrm_extra">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		for ($i=1; $i<=10; $i++) { 
			if ( $i == 1 ) {
				$extra_tit = "성별";
				//$it['it_'.$i] = $gender_arr[$it['it_'.$i]];
			}
			else if ( $i == 2 ) {
				$extra_tit = "연령";
				//$it['it_'.$i] = $age_arr[$it['it_'.$i]];
			}
			else if ( $i == 3 ) {
				$extra_tit = "스타일";
				//$it['it_'.$i] = $style_arr[$it['it_'.$i]];
			}
			else if ( $i == 4 ) {
				$extra_tit = "톤";
				//$it['it_'.$i] = $tone_arr[$it['it_'.$i]];
			}
			else if ( $i == 5 ) {
				$extra_tit = "언어";
				//$it['it_'.$i] = $language_arr[$it['it_'.$i]];
			}
			else if ( $i == 6 ) $extra_tit = "대본분량";
			else if ( $i == 7 ) $extra_tit = "대본파일";
			else if ( $i == 8 ) $extra_tit = "실제대본파일명";
			else continue;
		?>
        <tr>
            <th scope="row"><?php echo $extra_tit ?></th>
            <td class="td_extra">
...
//alert( "it_explain = " + $("textarea[name=it_explan]").val() );return false;
    return true;
}
