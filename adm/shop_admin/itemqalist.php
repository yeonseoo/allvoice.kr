...
$sql_common = "  from {$g5['g5_shop_item_qa_table']} a
                 ...
                 join {$g5['member_table']} c on (a.it_id = c.mb_no) ";
...
<select name="sfl" id="sfl">
    <option value="id" <?php echo get_selected($sfl, 'id'); ?>>성우회원</option>
...
<div class="tbl_head01 tbl_wrap" id="itemqalist">
    ...
    <tr>
        ...
        <th scope="col"><?php echo subject_sort_link('id'); ?>성우회원</a></th>
    ...
    <tr class="<?php echo $bg; ?>">
        <td class="td_chk">
            <label for="chk_<?php echo $i; ?>" class="sound_only"><?php echo get_text($row['iq_subject']) ?> 응원메시지</label>
            <input type="checkbox" name="chk[]" value="<?php echo $i ?>" id="chk_<?php echo $i; ?>">
            <input type="hidden" name="iq_id[<?php echo $i; ?>]" value="<?php echo $row['iq_id']; ?>">
        </td>
        <td class="td_left"><a href="<?php echo $href; ?>"><?php echo get_it_image($row['it_id'], 50, 50); ?> <?php echo $row['id']; ?></a></td>
        <td class="td_left">
