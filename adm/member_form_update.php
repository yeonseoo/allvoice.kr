...
$sql_common = "  mb_name = '{$_POST['mb_name']}',
                 ...
                 mb_9 = '{$_POST['mb_9']}',
                 mb_10 = '{$_POST['mb_10']}',
                 mb_network_from = '{$_POST['mb_network_from']}',
                 mb_network_year = '{$_POST['mb_network_year']}',
                 mb_order_block_yn = {$_POST['mb_order_block']},
                 mb_order_block_comment = '{$_POST['mb_order_block_comment']}' 
                 ";
