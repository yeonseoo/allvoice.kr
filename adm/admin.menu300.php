...
$menu['menu300'] = array (
	...
	array('300900', '보이스매칭', G5_ADMIN_URL.'/afterlist.php', 'scf_after', 1),
	...
	array('300510', '프로젝트관리', G5_ADMIN_URL.'/PR/pr_list.php', 'scf_contents', 1),
	array('300520', '투표관리', G5_ADMIN_URL.'/PR/vote_list.php', 'scf_contents', 1),
    array('300800', '1:1채팅 모니터링', G5_ADMIN_URL.'/adm_inbox_monitoring.php', 'adm_inbox_monitoring', 1),
);
?>