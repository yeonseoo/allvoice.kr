    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg" width="34" height="34" data-play="playable" class="not-started playable">',
                '<g class="shape">',
                '<circle class="progress-track" cx="50" cy="50" r="48" stroke="#302F32" stroke-opacity="0" stroke-linecap="round" fill="none" stroke-width="1"/>',
                '<circle class="precache-bar" cx="50" cy="50" r="48" stroke="#302F32" stroke-opacity="0" stroke-linecap="round" fill="none" stroke-width="1" transform="rotate(-90 50 50)"/>',
                '<circle class="progress-bar" cx="50" cy="50" r="48" stroke="#4e9bbc" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="1" transform="rotate(-90 50 50)"/>',
                '</g>',
                '<circle class="controls" cx="50" cy="50" r="48" stroke="none" fill="#000000" opacity="0.0" pointer-events="all"/>',
                '<g class="control pause">',
                '<line x1="45" y1="43" x2="45" y2="59" stroke="#4e9bbc" fill="none" stroke-width="6" stroke-linecap="round"/>',
                '<line x1="55" y1="43" x2="55" y2="59" stroke="#4e9bbc" fill="none" stroke-width="6" stroke-linecap="round"/>',
                '</g>',
                '<g class="control play">',
                '<polygon points="45,40 63,50 45,60" fill="#4e9bbc" stroke-width="0" stroke-linejoin="round" style="border-radius:3px;"></polygon>',
                '</g>',
