...
$content .= '<span style="display:inline-block;width:100px">변경될 비밀번호</span> <strong style="color:#ff3061">'.$change_password.'</strong><br>';
$content .= '<span style="margin:20;font-weight:bold;">꼭 아래의 버튼을 눌러 임시비밀번호로 로그인 해주세요!</span><br>';
$content .= '<span style="margin:10; font-size:large;color:red;">(*버튼을 누르지 않고 사이트로 접속 시 임시 비밀번호가 적용되지 않습니다.)</span>';
$content .= '</p>';
$content .= '<div class="lost_link" id="lost_link" style="margin:10px auto;width:30%">';
$content .= '<a class="lost_link" id="lost_link" href="'.$href.'" target="_blank" style="margin:10px auto;display:block;padding:20px 0;width:30% !important;background:#484848;color:#fff;text-decoration:none;text-align:center">비밀번호 변경</a>';
...
$mailAPI->sendMail($mb['mb_email'], $subject, $content);
