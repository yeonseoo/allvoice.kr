        ...
        <div class="step3">
            <div class="tabwrap">
                ...
                <ul class="tabs">
                    ...
                    <li>
                        <a class="active" href="#"><span class="chkBoxImg"></span>법인</a>
                            ...
                            <div class="tabbox">
                                <form id="form_signup_company" method="post" action="./signup_company_update.php" enctype="MULTIPART/FORM-DATA" autocomplete="off">
                                    ...
                                    <div class="inputType1">
                                        ...
                                        <div class="">
                                            <input type="text" id="mp_hp" name="mb_hp" placeholder="휴대폰번호를 입력해주세요">
                                            <label for="mp_hp"></label>
                                    ...
                                    <div class="inputTxt mt_50 mb_40">
                                        <p class="itemTxt">사업자 등록 번호</p>
                                        <input type="text" id="company_no" name="company_no" placeholder="사업자등록번호를 입력해주세요">
                                        <label for="company_no"></label>
                                    </div>

                                    <div class="inputType1">
                                        <p class="itemTxt">사업자 등록 사본</p>
                                        <div class="">
                                            <div class="filebox">
                                                <input class="upload-name" name="mb_tax_id_no" value="" placeholder="사업자등록증 사본 파일 첨부">
                                                <label for="company_no_file">사본첨부</label>
                                                <input type="file" id="company_no_file" name="company_no_file" class="upload-hidden">
                                            </div>
                                        </div>
