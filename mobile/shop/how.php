...
?>
    ...
    <div class="ectCont">
        <div class="contTop">
            ...
            <hr/>
            <span>올보이스에서는 고객님의 신속하고 편리한 <br/>작업진행을 위해 두가지 판매 옵션을 제공하고 있습니다.</span>
        </div>
        ...
        <div class="contMidW" style="padding-bottom:0;">
			...
			<?php
                    ...
                    ?>
				<a href="#download_functions|download_url$<?php echo G5_SHOP_URL; ?>/Site Use Guide-Client.pdf|download_name$Site Use Guide-Client.pdf">클라이언트 가이드 다운로드</a>
				<a href="#download_functions|download_url$<?php echo G5_SHOP_URL; ?>/Site Use Guide-Voice actor.pdf|download_name$Site Use Guide-Voice actor.pdf">프로성우 가이드 다운로드</a>
			<?php
                }
                ?>
			-->
    ...
    <div class="contMidW">
        <div>
            ...
            <div class="centerDiv">
                <span class="blueBox2" >OPTION 1. 성우에게 바로 작업요청 하기</span>
            </div>
            <ul class="stepB">
                <li class="l2">목소리<br/>샘플 듣기</li>
                <li class="l2">1:1<br/>채팅문의</li>
                <li>결제</li>
                <li class="l2">안심번호 통화</li>
    ...
    <div class="contMidG">
        <div>
            ...
            <ul class="stepR">
                <li class="l2">오디션<br/>등록</li>
                <li class="l2">성우님<br/>지원받기</li>
                <li class="l2">성우님<br/>선택</li>
                <li>결제</li>
                <li class="l2">안심번호 통화</li>
                <li>작업 완료</li>
            </ul>
            <ol class="step01">
                ...
                <li>
                    ...
                    <strong>안심번호 통화</strong>
                    <p>결제가 완료되면 안심번호를 성우님 프로필 페이지에서 확인할 수 있습니다.
                        <br/>음성통화를 통해 작업 내용 및 목소리를 조율 해주세요.
                        <br/>1:1 채팅창을 통해 성우님께 요청사항을 전달하실 수도 있습니다.</p>
                </li>
                <li>
                    <span>06</span>
                    <strong>작업완료</strong>
