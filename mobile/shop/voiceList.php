...
$qry = "SELECT a.*, b.mb_name, b.it_use_avg, c.cnt FROM " . $g5['member_voice'] . " a 
        ...
        $condition  AND b.mb_gubun = '3' GROUP BY a.mb_id ORDER BY  a.mv_no DESC, a.mb_id ASC, a.mv_no ASC";
...
<div class="allWrap">
    <header class="subHd voiceList">
        ...
        <div class="frame" id="basic">
            <ul class="clearfix">
                <li value="1"><a href="/shop/voiceList.php?cat=1">전체</a></li>
                <li value="10"><a href="/shop/voiceList.php?cat=10">광고</a></li>
                <li value="11"><a href="/shop/voiceList.php?cat=11">홍보</a></li>
                <li value="12"><a href="/shop/voiceList.php?cat=12">방송</a></li>
                <li value="13"><a href="/shop/voiceList.php?cat=13">만화</a></li>
                <li value="14"><a href="/shop/voiceList.php?cat=14">게임</a></li>
                <li value="15"><a href="/shop/voiceList.php?cat=15">영화예고</a></li>
                <li value="16"><a href="/shop/voiceList.php?cat=16">이벤트</a></li>
                <li value="17"><a href="/shop/voiceList.php?cat=17">오디오북,교재</a></li>
                <li value="18"><a href="/shop/voiceList.php?cat=18">기기음성,성대모사</a></li>
                <li value="19"><a href="/shop/voiceList.php?cat=19">ARS,안내멘트</a></li>
                <li value="20"><a href="/shop/voiceList.php?cat=20">홈쇼핑</a></li>
                <li value="21"><a href="/shop/voiceList.php?cat=21">비상업용</a></li>
                <li ></li>
                <!--
                <li value="1">전체</li>
                <li value="10">광고</li>
