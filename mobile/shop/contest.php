...
include_once(G5_THEME_MSHOP_PATH.'/shop.head1.php');
?>
<style>
#ttrxFooter {margin-top:0;}
</style>
<!-- 성우상세 { -->
<div class="contTop2 contestTop" style="margin-top:-20px;">
<div class="inner">
...
<div class="listContest">
		<ul>
			...
			<li><a href="?mode=end"  <?php if($mode=="end") echo 'class="on"'?>>프로젝트 종료</a></li>
		</ul>
	</div>
...
?>		
		...
		<ul class="listData_new">
			...
			<li>
    			...
    			<div>
                    ...
                    <p class="btn_wrap"><a href="#layer1" class="btn-layer" data-id="<?php echo $row['pr_id']?>" data-vote="<?php echo $vote_email?>" >참가하기</a></p>
    			</div>
			</li>
			<?php
			}
		...
		<div class="ttrxPaging1"><?php echo get_paging(G5_IS_MOBILE ? $config['cf_mobile_pages'] : $config['cf_write_pages'], $page, $total_page, '?mode='.$mode.$qstr.'&amp;page=');?></div>		
...
<div class="dim-layer">
    ...
    <div id="layer1" class="pop-layer">
        <div class="pop-container">
                ...
                <p>참여해주신분 중, 추첨을 통하여<br/> 소정의 상품을 증정합니다.  <br/>'상품, 이벤트 안내를 위한 이메일을 입력해주세요.</p>
                <p class="input_wrap"><input type="text"  name="email_1" required style="width:45%;float:left;"> @ <select name="email_select" onchange="email_check()" style="width:48%;float:right;"><option>선택하기</option>
				<option value='empal.com' <?if($my_email[1]=="empal.com"){?>selected<?}?>>empal.com</option>
						  ...
						  </select> <input name="email_2" id="email_2" type="text" style="margin-top:5px;width:100%;" required></p>
