...
?>
    <!-- 성우상세 { -->
    <div class="contTop2">
        <strong>보이스매칭(Voice Matching) 프로그램 신청</strong>
        <hr/>
        <span>크리에이터, 캐릭터, 등 보이스가 지속적으로 필요한<br/> 모든 콘텐츠와 프로성우를 매칭시켜드립니다.<br/><br/>
    ...
    <div class="voiceDetail">
        ...
        <div class="voiceDetailInfo">
            <form id="fitemform" name="fitemform" action="mailSend.php" method="post" enctype="MULTIPART/FORM-DATA" autocomplete="off">
                    ...
                    <ul>
                        <li>
                            ...
                            <ul>
                                ...
                                <li><span>예상 성우료</span><input type="text" id="it_purpose" name="it_purpose" value=""/></li>
                ...
                <div class="ctrler">
                    <a id="submit_btn" class="vSave" style="cursor:pointer;display:block;margin:0 auto;float:none;">신청하기</a>
