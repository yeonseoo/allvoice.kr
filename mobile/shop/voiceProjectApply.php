...
?>
    ...
    <div class="contTop3">
        ...
        <hr/>
        <span>특정성우를 선택하지 않고 예산에 맞는 성우와 <br/>작업하고자 하는 경우 1:다수(고객:다수의 성우) <br/>오디션 등록을 통해 여러 성우들의 지원을 받을 수 있습니다.<br/>샘플멘트를 올려 보세요. <br/>지원하는 성우분들의 샘플 멘트를 들어보시고 <br/>고객님께 가장 적합한 성우를 선택 하실수 있습니다. </span>
    </div>
                    ...
                    <ul>
                        <li>
							...
							<span class="slcWrap">
                                ...
                                <li>
                                    <div class="fakeFile">
                                        <input type="text" id="it_img1_name" value="" style="width:calc(100% - 92px);"/>
                                        <div><input type="file" id="it_img1" name="it_img1"/></div>
                                    </div>
                                </li>
                                <li>
                                    관리자의 심사 결과에 따라 홈페이지에 노출되며 지원 현황은 <br/>등록한 작업 상세페이지에서 확인하실 수 있습니다.
                                </li>
                            </ul>
                        </li>
                    </ul>
