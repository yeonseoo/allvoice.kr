...
<!-- 성우상세 { -->
<div class="contTop2 contestTopdetail" style="background: url('<?php echo $thumb_bg['src']?>') no-repeat center center;margin-top:-33px;">
		...
		<div class="contest_sec_wrap">
           ...
           <div class="Player_wrap">
		    <?php
				if($m==0){
			?>
           	<div class="player_name"><span>1등</span> 후보 <img src="/img/no1.png" alt="" style="width:22px;"/></div>
			<?php
				}else{
			?>
			<div class="player_name"><img src="/img/icon1.png" alt="" style="width:12px;"/> 후보<?php echo $m+1?> </div>
			<?php } ?>
				<div class="tagPlayer">
					<div>
