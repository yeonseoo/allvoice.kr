...
<!-- 성우상세 { -->
<div class="contTop2 contestTopdetail" style="background: url(../img/sample2.png) no-repeat center center;margin-top:-33px;">
	<div class="inner">
	<span class="date">진행기간 2019.05.06 ~ 18</span>
	<strong>메이플스토리 신규캐릭터<br/>올보이스 오디션</strong>
	
	<span>넥슨에서 제작하는 메이플스토리 신규캐릭터 2명을 올보이스와함께 오디션을 진행합니다.
캐릭터 스타일은 귀여운궁수와 호걸타입의 캐릭터입니다.</span>
</div>
</div>


<div class="listWrap project" style="background:#fff;">
	<div class="listCont">
		<!-- 캐릭터 -->
...
전투중의 모습을 본 사람이라면 모두가 반해버릴 미모소유자로 털털하고 귀여운 캐릭터입니다.</p>
           ...
           <div class="Player_wrap">
           	<div class="player_name"><span>1등</span> 후보 <img src="/img/no1.png" style="width:22px;" alt=""/></div>
				<div class="tagPlayer">
					<!--div>
...
<p class="vote_btn_wrap"><a href="#layer2" class="btn-layer vote_btn">투표 참여하기</a></p>

</div>
 <!-- //sec1 -->
 <!-- sec1 -->
           <div class="Player_wrap">
           	<div class="player_name"><img src="/img/icon1.png" alt="" style="width:12px;"/> 후보2 </div>
				<div class="tagPlayer">
					<!--div>
						<strong><?php echo $row['mv_title']; ?></strong>
						<span><?php echo $category_arr[$row['mv_cat']]; ?></span>
...
<!--div class="bo_fx" style="width:100%;margin:0 auto;text-align:right;">
    ...
    <div class="dimBg"></div>
        ...
        <div class="pop-container">
                ...
                <p class="pop-btn-wrap">
                	 <a href="contest_detail_ok.php" class="btn-layer blue-btn">확인</a>
                </p>
