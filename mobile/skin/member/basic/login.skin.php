...
<div id="mb_login" class="mbskin">
    ...
    <section class="mb_login_join">
        ...
        <div>
            <a href="javascript:;" id="accInfoFind" style="border-right:1px solid #cdcdcd;">회원정보찾기</a>
            <a href="<?php echo G5_SHOP_URL; ?>/voiceSignup.php">회원 가입</a>
        </div>
    </section>
...
<style type="text/css">
#accInfoFindCover{position:fixed;top:0;left:0;width:100%;height:100%;background-color:rgba(0,0,0,0.5);display:none;z-index:4000;}
#accInfoFindPop{position:fixed;top:10vh;left:5vw;width:90vw;height:80vh;display:none;z-index:4100;}
#accInfoFindPop > a{position:absolute;top:0;right:-10px;color:#fff;font-family: sans-serif;display:block;padding:10px;font-size:20px;font-weight:bold;line-height:28px;}
#accInfoFindPop > iframe{width:100%;height:calc(80vh - 48px);margin-top:48px;border:0;}
</style>
<div id="accInfoFindCover">
</div>
<div id="accInfoFindPop">
	<a href="javascript:;">Ⅹ</a>
	<iframe src="<?php echo G5_BBS_URL ?>/password_lost.php"></iframe>
</div>
...
$(function(){
	...
	$("#accInfoFind").click(function(){
		$("#accInfoFindCover").show();
		$("#accInfoFindPop").show();
	});
	$("#accInfoFindPop > a, #accInfoFindCover").click(function(){
		$("#accInfoFindCover").hide();
		$("#accInfoFindPop").hide();
	});

	$("#accInfoFindPop > iframe").ready(function(){
		//$("#accInfoFindCover").hide();
		//$("#accInfoFindPop").hide();
		//console.log(loadCnt);
	});
