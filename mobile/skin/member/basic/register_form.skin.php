        ...
        <div id="register_form" class="form_01">
            <table class="joinForm">
                ...
                <tr id="company1" <?php echo $member['mb_gubun'] == "2" ? "" : "style='display:none'" ?>>
                    <th>업체명</th>
                    <td><input type="text" name="mb_4" value="<?php echo isset($member['mb_4']) ? $member['mb_4'] : ''; ?>" id="reg_mb_4" class="frm_input full_input" size="70" maxlength="100"></td>
                </tr>
                <tr id="company2" <?php echo $member['mb_gubun'] == "2" ? "" : "style='display:none'" ?>>
                    <th>사업자등록번호</th>
                    <td><input type="text" name="mb_5" value="<?php echo isset($member['mb_5']) ? $member['mb_5'] : ''; ?>" id="reg_mb_5" class="frm_input full_input" size="70" maxlength="100"></td>
                </tr>
                <tr id="company3" <?php echo $member['mb_gubun'] == "2" ? "" : "style='display:none'" ?>>
                    <th>업태</th>
                    <td><input type="text" name="mb_6" value="<?php echo isset($member['mb_6']) ? $member['mb_6'] : ''; ?>" id="reg_mb_6" class="frm_input full_input" size="70" maxlength="100"></td>
                </tr>
                <tr id="company4" <?php echo $member['mb_gubun'] == "2" ? "" : "style='display:none'" ?>>
                    <th>종목</th>
                    <td><input type="text" name="mb_7" value="<?php echo isset($member['mb_7']) ? $member['mb_7'] : ''; ?>" id="reg_mb_7" class="frm_input full_input" size="70" maxlength="100"></td>
                </tr>
                </tbody>
            </table>
