...
<script src="<?php echo G5_JS_URL; ?>/viewimageresize.js"></script>
    ...
    ?>
    				<a href="javascript:;">
    					<strong><?php echo $iq_subject; ?></strong>
    					<div>
    						<?php echo nl2br($iq_question); // 사용후기 내용 ?>
    ...
    if (!$i) echo '<p class="sit_empty">응원메시지가 없습니다.</p>';
    ?>
...
?>
    			...
    			<div class="tableWrite">
    				<a href="<?php echo $itemqa_form; ?>" class="reviewTable itemqa_form">응원메시지 작성</a>
    			</div>
