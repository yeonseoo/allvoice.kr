...
if (G5_IS_MOBILE) {
    include_once(G5_MSHOP_PATH.'/voiceProject.php');
    return;
}
...
<style type="text/css">
.projectList{display:inline-block;}
.subCateDep02{z-index:90;}
</style>
...
$(function(){
	$("#subCateDep01 a").removeClass("on");
	$("#subCateDep01 > div > span > a").addClass("on");
});
</script>
