...
if(isset($data['pp_id']) && $data['pp_id']) {   //개인결제
	...
	$_REQUEST['mode'] = "pay";
	$_REQUEST['od_id'] = $orderNumber;
	$_REQUEST['ct_id'] = get_session('ss_cart_direct');
	include_once(G5_SHOP_PATH.'/voiceMypageOrderDetail_update.php');
}
?>