            ...
            <div class="voiceDetailSection">
                <div class="voiceDetailTab tab3">
                    <ul>
                        ...
                        <li><a href="javascript:;">녹음 의뢰 주문 내역</a></li>
                    </ul>
                </div>
                <div>
                    <div class="tableSet02">
                        <table>
                            ...
                            <tbody>
                            <?php
                            if ($member['mb_gubun'] == "3" || $member['mb_gubun'] == "4") $sub_where = " AND (a.it_origin='" . $member['mb_id'] . "' OR b.mb_id='" . $member['mb_id'] . "') AND c.od_status IN ('작업진행중','작업완료','취소') ";
                            ...
                            for ($i = 0; $row = sql_fetch_array($res); $i++) {
                                ...
                                if ($row['od_status']) {
                                    ...
                                    $od_status = "미채택";
                                    $css = "orderStatus05";
                                } else if (!$row['od_status'] && ($row['it_gubun'] == "3" || $row['it_gubun'] == "4")) {
                                    $od_status = "의뢰완료";
                                    $css = "orderStatus04";
                                }
                                ?>
                                <tr>
                                    ...
                                    <td><?php echo number_format($row['od_misu'] < 0 ? 0 : $row['od_misu']); ?>원</td>
                                </tr>
                                <?php
                            }
                            ?>
                    ...
                    <div class="tableSet02">
                        <table>
                            ...
                            <tr>
                                ...
                                <th>제안금액</th>
                                <th>최종 결제 금액</th>
                                <th><?php echo ($member['mb_gubun'] == "3" || $member['mb_gubun'] == "4") ? "구매자" : "판매자"; ?></th>
                                <th>의뢰일</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php
                            if ($member['mb_gubun'] == "3" || $member['mb_gubun'] == "4") $sub_where = " AND (a.it_origin='" . $member['mb_id'] . "' OR b.mb_id='" . $member['mb_id'] . "') ";
                            ...
                            for ($i = 0; $row = sql_fetch_array($res); $i++) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo number_format($row['od_receipt_price']); ?>원</td>
                                    <td><?php echo ($member['mb_gubun'] == "3" || $member['mb_gubun'] == "4") ? $row['it_maker'] : $row['it_origin']; ?></td>
            ...
            <div class="voiceDetailSection">
                <div class="voiceDetailTab tab3">
                    <ul>
                        <li><a href="javascript:;">최근 거래 내역</a></li>
                        <li><a href="javascript:;">문의 주문 내역</a></li>
                        <li class="on"><a href="javascript:;">녹음 의뢰 주문 내역</a></li>
                    </ul>
                </div>
                <div>
                    <div class="tableSet02">
                        <table>
                            ...
                            for ($i = 0; $row = sql_fetch_array($res); $i++) {
                                ...
                                if ($row['od_status'] == "채택완료" && ($member['mb_gubun'] != "3" || $member['mb_gubun'] != "4")) {
                                    $od_status = "마감";
                                } else if (!$row['od_status'] && $row['it_gubun'] == "1" && $row['it_use'] == "0") {
                                    $od_status = "등록대기";
                                    $css = "orderStatus05";
                                } else if (!$row['od_status'] && $row['it_gubun'] == "1" && ($member['mb_gubun'] == "3" || $member['mb_gubun'] == "4")) {    // 성우회원이면
                                    $od_status = "미채택";
                                    $css = "orderStatus05";
                                } else if ((!$row['od_status'] || $row['od_status'] == "지원완료") && $row['it_gubun'] == "1" && ($member['mb_gubun'] != "3" || $member['mb_gubun'] != "4")) {    // 일반회원이면
                                    $od_status = "진행중";
                                    $css = "orderStatus05";
                                } else if (!$row['od_status'] && ($row['it_gubun'] == "3" || $row['it_gubun'] == "4")) {
                                    $od_status = "의뢰완료";
