...
if (G5_IS_MOBILE) {
    include_once(G5_MSHOP_PATH.'/voiceMypageOrderDetail01.php');
    return;
}
...
<div class="voiceMypage">
	<div class="voiceDetailInfo">
				...
				<div class="orderDetailView">
    				...
    				<ul class="orderDetailViewCont">
    					<li>
    						<span>상태</span>
    						<div>
    							<span class="orderStatus orderStatus04">의뢰완료</span>
    						</div>
    					</li>
    					<li>
    						<span>제목</span>
		...
		<div class="ctrler">
			<a class="vSave" style="cursor:pointer;">거래 합의하기</a>
			<a href="javascript:;" class="vCancel">의뢰 취소하기</a>
		</div>
	</div>
