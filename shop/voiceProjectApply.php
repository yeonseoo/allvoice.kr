...
if (G5_IS_MOBILE) {
    include_once(G5_MSHOP_PATH.'/voiceProjectApply.php');
    return;
}
...
<div class="contTop" style="opacity:0;">
	...
	<hr />
	<span>특정성우를 선택하지 않고 예산에 맞는 성우와 작업하고자 하는 경우 1:다수(고객:다수의 성우) 오디션 등록을 통해 여러 성우들의 지원을 받을 수 있습니다.<br />샘플멘트를 올려 보세요. 지원하는 성우분들의 샘플 멘트를 들어보시고 고객님께 가장 적합한 성우를 선택 하실수 있습니다. </span>
</div>

<script type="text/javascript">
$(function(){
	$("#contentsWrap > div").before("<div class='contTop3'>"+$(".contTop").html()+"</div>");
	$(".contTop").remove();
});
</script>
...
<div class="voiceDetail">
	<div class="voiceDetailInfo">
		...
		<div class="voiceSampleSection form">
			<strong>오디션 등록하기</strong>
			<ul>
				<li>
<!-- 					<strong>샘플음성 01</strong> -->
					<ul>
						<li><span>*제목</span><input type="text" id="it_name" name="it_name" value="" /></li>
						<li><span>*설명</span><textarea rows="3" id="it_explan" name="it_explan"></textarea></li>
						<li>
							<span>*대본샘플</span><textarea rows="3" id="it_explan2" name="it_explan2" placeholder="들어보기 원하시는 샘플 한 문장을 적어주세요."></textarea>
						</li>
						<li>
							<span>의뢰할 대본</span>
						...
						<li><span>*예산</span><input type="text" id="it_price" name="it_price" numberOnly /><i>※ 최저가격 <span id="ch_pr"></span>원 이상으로 작성해주세요</i><i>※ 광고 작업의 경우 공중파 광고는 기본금액 25만원 이상으로 적어주시기 바랍니다</i></li>
						<li><span>성별</span>
							<span class="slcWrap">
						...
						<li><span>*노출기간</span><input type="text" id="it_view_time" name="it_view_time" data-language='ko' readOnly>
							<em class="xi-calendar-check"></em>
						</li>
						<li>
							<span>대표이미지</span>
							<div class="fakeFile">
						...
						<li>
							<span>&nbsp;</span>
							관리자의 심사 결과에 따라 홈페이지에 노출되며 지원 현황은 등록한 작업 상세페이지에서 확인하실 수 있습니다.
						</li>
					</ul>
				</li>
...
<!-- 			<a href="javascript:;" class="vCancel">취소</a> -->
	...
	<div class="voiceProfile">
		...
		<hr />
		<a href="<?php echo G5_SHOP_URL; ?>/how.php" class="sendMassage">이용안내 전체 보기</a>
		<a href="<?php echo G5_URL; ?>/bbs/faq.php" class="sendMassage">FAQ 전체 보기</a>
	</div>
</div>
