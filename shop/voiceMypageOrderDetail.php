...
$qry = "SELECT a.*,c.*,d.ca_name,b.ct_id FROM " . $g5['g5_shop_item_table'] . " AS a LEFT JOIN " . $g5['g5_shop_cart_table'] . " AS b ON a.it_id=b.it_id LEFT JOIN " . $g5['g5_shop_order_table'] . " AS c ON b.od_id=c.od_id JOIN " . $g5['g5_shop_category_table'] . " AS d ON a.ca_id=d.ca_id WHERE a." . $gubun_id . "='" . $member['mb_id'] . "' AND a.it_id='" . $_REQUEST['it_id'] . "'" . $sub_where;
                                ...
                                <div class="tax_cash_wrap">
                                    ...
                                    <div class="tax_box tax">
                                        ...
                                        <div class="new_info box_none">
                                            ...
                                            <dl class="clearfix">
                                                <dt>사업장 소재지</dt>
                                                <dd>
                                                    <input type="text" name="delivery_return_zip" value="" class="input_150" readonly>
                                                    ...
                                                    <input type="text" name="delivery_return_addr2" value="" placeholder="나머지주소" class="input_100">
                                    ...
                                    <div class="cash_box cash box_none">
                                        ...
                                        <dl class="clearfix cell box_none show">
                                            <dt>휴대폰번호</dt>
                                            <dd>
                                                <input type="number" name="ph1" value="" class="cls_cn input_150">
                                                -
                                                <input type="number" name="ph2" value="" class="cls_cn input_150">
                                                -
                                                <input type="number" name="ph3" value="" class="cls_cn input_150">
                                            </dd>
                                        </dl>
                                        <dl class="clearfix num box_none">
                                            <dt>사업자등록번호</dt>
                                            <dd>
                                                <input type="number" name="coNumber1" value="" class="cls_cn input_150">
                                                -
                                                <input type="number" name="coNumber2" value="" class="cls_cn input_150">
                                                -
                                                <input type="number" name="coNumber3" value="" class="cls_cn input_150">
                                            </dd>
                                        </dl>
                                        <dl class="clearfix card box_none">
                                            <dt>현금영수증 카드번호</dt>
                                            <dd>
                                                <input type="number" name="ca1" value="" class="cls_cn input_100px">
                                                -
                                                <input type="number" name="ca2" value="" class="cls_cn input_100px">
                                                -
                                                <input type="number" name="ca3" value="" class="cls_cn input_100px">
                                                -
                                                <input type="number" name="ca4" value="" class="cls_cn input_100px">
                                            </dd>
                                        </dl>
                                    </div>
